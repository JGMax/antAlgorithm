...
object Constants {
    const val DISAPPEARANCE: Double = 0.3
    ...
    const val ELITE_POPULATION: Int = 100

    const val STOP_TIME_MILLIS: Int = -1 // -1 is logic
    const val STOP_PERCENTAGE: Double = 0.7

    const val MIN_PHEROMONE: Double = 1.0
    const val MAX_PHEROMONE: Double = 1000.0 // -1 is infinite
    const val DEFAULT_PHEROMONE: Double = 10.0
    ...
    const val PHEROMONE_ADD: Double = 87000.0
